...
def start_experiment(args):
    ...
    for volume in range(10):
        if volume == 0:
            volume_list.append(os.path.join(args.input_data,  'ta1-theia-e3-official-1r.json'))
        else:
            volume_list.append(os.path.join(args.input_data,  'ta1-theia-e3-official-1r.json')+f'.{volume}')
    
    volume_list.append(os.path.join(args.input_data,  'ta1-theia-e3-official-3.json'))
    volume_list.append(os.path.join(args.input_data,  'ta1-theia-e3-official-5m.json'))

    for volume in range(13):
        if volume == 0:
            volume_list.append(os.path.join(args.input_data,  'ta1-theia-e3-official-6r.json'))
        else:
            volume_list.append(os.path.join(args.input_data,  'ta1-theia-e3-official-6r.json')+f'.{volume}')
