...
def parse_event_optc(log_data, node_buffer):
    dt = isoparse(log_data['timestamp'])
...
def start_experiment(args):
    ...
    volume_list = [
    'benign_filter/AIA-51-75.ecar-2019-12-07T16-15-43.163.json',
    'benign_filter/AIA-51-75.ecar-2019-12-07T18-18-31.331.json',
    'benign_filter/AIA-51-75.ecar-2019-12-07T21-31-30.259.json',
    'benign_filter/AIA-51-75.ecar-2019-12-08T00-56-58.175.json',
    'benign_filter/AIA-51-75.ecar-2019-12-08T04-30-36.852.json',
    'benign_filter/AIA-51-75.ecar-last.json'
    ] 
